<template>
  <div class="city-select">
    <select class="input-address" v-model="selectedProvince" name="province">
    ...
    <select class="input-address" v-model="selectedCity" name="city">
      <option
    ...
    <select class="input-address" v-model="selectedBlock" name="block">
      <option
